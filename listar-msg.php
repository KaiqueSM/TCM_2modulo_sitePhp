        ...
        <div id="conteudo">
            ...
            <table id="tbl">
                <?php
                    ...
                    $comando=mysql_query("select * from tbl_mensagem");
                    echo "<tr class='titulo'><th>Código</th><th>Nome do cliente</th><th>E-mail</th><th>Assunto</th></tr>";
                    
                    while ($linha=mysql_fetch_array($comando))
                    {
                        $codigo=$linha['cd_contato'];
                        $nome=$linha['nm_cliente'];
                        $email=$linha['email'];
                        $mensagem=$linha['mensagem'];

                        //imprimindo o vetor
                        echo "<tr><td>$codigo</td><td>$nome</td><td>$email</td><td class='msg'>$mensagem</td></tr>";
                    }
            ...
            <section>
            <form method="POST" action="exclui-msg.php">
